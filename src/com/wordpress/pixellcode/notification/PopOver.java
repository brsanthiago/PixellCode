...
public class PopOver extends PopupControl {
	...
	private static final String DEFAULT_STYLE_CLASS = "snack";

	private static final Duration DEFAULT_FADE_DURATION = Duration.seconds(.1);
	...
	private double computeXOffset() {
		...
		case TOP_RIGHT:
		case BOTTOM_RIGHT:
			return getContentNode().prefWidth(-1) - getArrowIndent() - getCornerRadius() - getArrowSize();
		default:
			return 0;
		}
	}
	...
	private double computeYOffset() {
		...
		case LEFT_CENTER:
		case RIGHT_CENTER:
			return Math.max(prefContentHeight, 2 * (getCornerRadius() + getArrowIndent() + getArrowSize())) / 2;
		case LEFT_BOTTOM:
		case RIGHT_BOTTOM:
			return Math.max(prefContentHeight - getCornerRadius() - getArrowIndent() - getArrowSize(),
	...
	private final BooleanProperty detachable = new SimpleBooleanProperty(this, "detachable", true); //$NON-NLS-1$
	...
	private final BooleanProperty detached = new SimpleBooleanProperty(this, "detached", false); //$NON-NLS-1$
	...
	private final DoubleProperty arrowSize = new SimpleDoubleProperty(this, "arrowSize", 12); //$NON-NLS-1$
	...
	private final DoubleProperty arrowIndent = new SimpleDoubleProperty(this, "arrowIndent", 12); //$NON-NLS-1$
	...
	private final DoubleProperty cornerRadius = new SimpleDoubleProperty(this, "cornerRadius", 6); //$NON-NLS-1$
	...
	private final StringProperty detachedTitle = new SimpleStringProperty(this, "detachedTitle", "Info"); //$NON-NLS-1$ //$NON-NLS-2$
	...
	private final ObjectProperty<ArrowLocation> arrowLocation = new SimpleObjectProperty<>(this, "arrowLocation", //$NON-NLS-1$
